...
### Пояснения:
- Файл zoo.py содержит все классы и методы, необходимые для работы зоопарка.
- Файл main.py использует эти классы для создания экземпляра зоопарка, добавления животных и сотрудников, а также для сохранения и загрузки состояния зоопарка.